...
class User1Service {
    ...
    */
    public function obtainUsers1() {
        return $this->performRequest('GET','/users'); //<—this code will call the GET localhost:8001/users (our site1)
    }
    ...
    */
    public function createUser1($data) {
        return $this->performRequest('POST', '/users',$data); //<-this code will post another record in site1
    }
