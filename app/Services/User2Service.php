...
class User2Service {
    ...
    */
    public function obtainUsers2() {
        return $this->performRequest('GET','/users'); //<—this code will call the GET localhost:8002/users (our site1)
    }
    ...
    */
    public function createUser2($data) {
        return $this->performRequest('POST', '/users',$data); //<-this code will post another record in site2
    }
